...
public static class PokerHandEvaluator
{
    ...
    {
        // 分离普通牌和王牌
        var t_Regular = p_Cards.Where(c =>c.Suit != Enum_CardSuit.大小王)
        ...
        foreach(var t_List in p_Target.Targets)
        {
            ...
            foreach (var t_CardRank in t_Target)
            {
                ...
                else
                {
                    ...
                    {
                        t_SubMatchedCards.Add(p_Jokers[t_JokerIndex], new Card(Enum_CardSuit.黑桃, t_CardRank));
                        t_JokerIndex++;
                    }
                }
            }
    ...
    private static List<List<Card>> m_GetAllSuit()
    {
        ...
        for (int i = (int)Enum_CardSuit.黑桃; i >= (int)Enum_CardSuit.方块; i--)
        {
